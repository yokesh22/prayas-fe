...
// Data for event highlights to enable mapping
const eventHighlights = [
  {
    id: 1,
    icon: "https://c.animaapp.com/mcwvg0grSIsRNR/img/vector-5.svg",
    iconWidth: "122px",
    iconHeight: "110px",
    text: "200+\ncrops\non display",
  },
  {
    id: 2,
    icon: "https://c.animaapp.com/mcwvg0grSIsRNR/img/vector-1.svg",
    iconWidth: "86.6px",
    iconHeight: "92px",
  ...
  {
    id: 3,
    icon: "https://c.animaapp.com/mcwvg0grSIsRNR/img/vector.svg",
    iconWidth: "82px",
    iconHeight: "83px",
  ...
  {
    id: 4,
    icon: "https://c.animaapp.com/mcwvg0grSIsRNR/img/group-6.png",
    iconWidth: "87.99px",
    iconHeight: "88.01px",
  ...
  {
    id: 5,
    icon: "https://c.animaapp.com/mcwvg0grSIsRNR/img/vector-2.svg",
    iconWidth: "132px",
    iconHeight: "115px",
...
export const ExhibitorLogosSection = (): JSX.Element => {
  ...
  const getColumnCount = () => {
    if (isExtraSmall) return 2; // Two columns for mobile view
    if (isSmall) return 2;
              ...
              >
                ...
                >
                  <Box
                    component="img"
                    src={highlight.icon}
                    alt={`Highlight icon ${highlight.id}`}
                    sx={{
                      width: { xs: highlight.iconWidth === "132px" ? "70px" : "60px", sm: highlight.iconWidth },
                      height: { xs: highlight.iconHeight === "115px" ? "65px" : "55px", sm: highlight.iconHeight },
                      mb: { xs: 1, sm: 2 },
                      objectFit: "contain",
                    }}
                  />
